    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          config.debug("watching invalidate-------<>-----, ".concat(config.uuid, ", <>------<>, ").concat(config.watch));
          _context4.next = 4;
          return config.watch.removeItem(config.uuid);
        case 4:
          _context4.next = 6;
          return config.store.removeItem(config.uuid);
        case 6:
...
function filter() {
  ...
  var needObservation = document.cacheDictionary[req.url];
  debug(needObservation, 'needObservationneedObservation');
  if (needObservation !== undefined) {
    var obj = needObservation.reduce(function (accumulator, value) {
      return _objectSpread(_objectSpread({}, accumulator), {}, _defineProperty({}, value, true));
    }, {});
    Object.assign(document.observation, obj);
    // observation[needObservation] = true
  }

  debug("filterrrrr-------<uuid>-----, ".concat(req.url, ", ").concat(document.included[req.url] !== undefined, ", '1111', ").concat(document.observation, ", ").concat(needObservation));
  return document.included[req.url] === undefined;
}
function exclude() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var req = arguments.length > 1 ? arguments[1] : undefined;
  var _config$exclude2 = config.exclude,
    exclude = _config$exclude2 === void 0 ? {} : _config$exclude2,
    debug = config.debug;
  ...
  var hasQueryParams = /\?.*$/.test(req.url) || Object(_utilities__WEBPACK_IMPORTED_MODULE_9__["isObject"])(req.params) && Object.keys(req.params).length !== 0 || typeof URLSearchParams !== 'undefined' && req.params instanceof URLSearchParams;
